package com.lotus.iminprinter.ui

import android.content.Context
import android.graphics.BitmapFactory
import android.util.Log
import com.imin.printerlib.IminPrintUtils
import com.lotus.iminprinter.R
...
class PrintUtil(private val context : Context) {
    ...
    fun printExample(){
        ...
        drawText(TextSize.SizeM, TextAlign.CENTER, "Erkan Kaplan")
        feedPaper(25)

        setFontStyle(FontStyle.NORMAL)
        drawText(TextSize.SizeS, "Date: 02 Apr 2025 23:59:59")
